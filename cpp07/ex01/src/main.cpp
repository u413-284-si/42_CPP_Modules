...
/*   Updated: 2024/04/05 21:58:33 by sqiu             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void){
	...
	const float	arr_float[ARR_SIZE] = {1.231f, 2.244f, 3.363f};
	...
	std::cout << "Manipulating non-const array\n";
	iter(arr_int, ARR_SIZE, &add);
	iter(arr_int, ARR_SIZE, &print);
	std::cout << std::endl;
